...
1. **Tải model** từ S3 bucket
2. **Đọc dữ liệu** từ file được tải lên
3. **Truy xuất** công thức tính điểm đang hoạt động của công ty từ DynamoDB
4. **Áp dụng** công thức lên dữ liệu để tính toán điểm số cuối cùng cho từng nhân viên
5. **Lưu** kết quả vào bảng Performance Score trong DynamoDB
6. **Tạo** phân tích và thông tin chi tiết
